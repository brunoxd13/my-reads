...
describe("Book", () => {
  ...
  it("Render the component book with meta info", () => {
    const wrapper = shallow(<Book {...props} />);
    expect(wrapper.find(".book-meta-info"));
  });

  it("Render the component book with meta info title", () => {
    const wrapper = shallow(<Book {...props} />);
    expect(wrapper.find(".book-meta-info").prop("title"));
  });

  it("Render the component book with meta info title", () => {
    const wrapper = shallow(<Book {...props} />);
    expect(wrapper.find(".book-meta-info").prop("description"));
  });

  it("Render the component book with image", () => {
    const wrapper = shallow(<Book {...props} />);
    expect(wrapper.find(".book-img").prop("src"));
  });

  it("Render the component book with rate", () => {
    const wrapper = shallow(<Book {...props} />);
    expect(wrapper.find(".book-rate"));
  });

  it("Render the component book with description", () => {
    const wrapper = shallow(<Book {...props} />);
    expect(wrapper.find(".book-description"));
  });

  it("Render the component book with description", () => {
    const wrapper = shallow(<Book {...props} />);
    expect(wrapper.find(".book-select"));
  });
});
