...
describe("BookShelves", () => {
  ...
  it("Render the component book shelves", () => {
    expect(shallow(<BookShelves {...props} />));
  });

  it("Render the component book shelves and verify if has container shelves", () => {
    const wrapper = shallow(<BookShelves {...props} />);
    expect(wrapper.find(".container-book-shelves"));
  });

  it("Render the component book shelves and verify if has shelf reading", () => {
    const wrapper = shallow(<BookShelves {...props} />);
    expect(wrapper.find(".container-book-shelves"));
  });
  ...
  it("Render the component book shelves and verify if has shelf reading", () => {
    const wrapper = shallow(<BookShelves {...props} />);
    expect(wrapper.find(".shelf-reading"));
  });

  it("Render the component book shelves and verify if has shelf want to read", () => {
    const wrapper = shallow(<BookShelves {...props} />);
    expect(wrapper.find(".shelf-want-read"));
  });

  it("Render the component book shelves and verify if has shelf read", () => {
    const wrapper = shallow(<BookShelves {...props} />);
    expect(wrapper.find(".shelf-read"));
  });
});
